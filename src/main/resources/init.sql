...
--password
insert into users(username, password, enabled) values ('nuser', '$2a$10$O4JtKIqr5Eg.jLIy6CY87eLJ.Y.wxQBDGFM/Wo3LZF.Z/r7bW1MW6', 1);
insert into users(username, password, enabled) values ('auser', '$2a$10$O4JtKIqr5Eg.jLIy6CY87eLJ.Y.wxQBDGFM/Wo3LZF.Z/r7bW1MW6', 1);
